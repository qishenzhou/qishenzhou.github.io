  ...
  function renderResearchPapers() {
    ...
    if (listEl) {
      ...
      paperDetails.forEach(function (p, i) {
        ...
        li.innerHTML = '<div class="paper-header"><strong class="paper-title"><span class="lang-zh">' + escapeHtml(p.title_zh) + '</span><span class="paper-title-en lang-en hidden">' + escapeHtml(p.title_en) + '</span></strong><span class="paper-venue">' + escapeHtml(p.venue) + ' · ' + escapeHtml(p.year) + '</span></div><div class="paper-content">' + thumbBlock + '<div class="paper-abstract-wrap"><p class="paper-abstract lang-zh">' + escapeHtml(p.abstract_zh) + '</p><p class="paper-abstract lang-en hidden">' + escapeHtml(p.abstract_en) + '</p></div></div><div class="paper-actions">' + paperActionTpl.replace(/INDEX/g, i) + '</div>';
